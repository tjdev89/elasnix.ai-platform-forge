...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "elasnix.ai builds AI-native enterprise platforms with Agentic AI, Kubernetes, DevOps, cloud-native infrastructure, and cybersecurity." },
      { name: "author", content: "elasnix.ai" },
      { property: "og:title", content: "elasnix.ai — Engineering Intelligent Digital Platforms" },
      { property: "og:description", content: "AI-native software engineering, cloud infrastructure, DevOps, and cybersecurity for the modern enterprise." },
